# Generated by Powerlevel10k configuration wizard on 2020-02-13 at 00:22 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=123
  # Don't show the number of background jobs.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VERBOSE=true
  # Custom icon.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='background'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=117
  ...
  #
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='.*wlp4s0.*'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=32
  ...
  function prompt_example() {
    p10k segment -b 1 -f 3 -i '⭐' -t 'hello'
  }
